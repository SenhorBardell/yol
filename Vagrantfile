...
public_folder         = "/vagrant/yol/public"
...
Vagrant.configure("2") do |config|
  ...
  config.vm.network :forwarded_port, host: 4570, guest: 8080
  config.vm.network :forwarded_port, host: 4568, guest: 1080
  config.vm.network :forwarded_port, host: 4569, guest: 1025

  # Use NFS for the shared folder
  config.vm.synced_folder "/Users/bardell/Projects/", "/vagrant",
            id: "core",
            :nfs => true,
